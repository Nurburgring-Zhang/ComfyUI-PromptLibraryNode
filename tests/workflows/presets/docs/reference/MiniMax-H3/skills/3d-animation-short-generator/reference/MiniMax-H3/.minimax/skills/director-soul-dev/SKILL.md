...
├── docs/  # 30+ .md (PHASE_*, 阶段记录)
├── archive/_trash/  # 129 临时文件 (备份)
├── .minimax/skills/general-dev/  # 通用 SKILL
├── .minimax/harness/general-dev/  # 通用 HARNESS
└── .minimax/skills/director-soul-dev/  # 项目特定 sub-skill
```
...
- **通用规则**: `.minimax/skills/general-dev/SKILL.md` (5 错误模式 + 7 硬约束)
- **通用检查**: `.minimax/harness/general-dev/HARNESS.md` (开发前/中/后)
