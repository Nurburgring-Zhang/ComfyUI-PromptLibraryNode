# -*- coding: utf-8 -*-
"""
MusicScorePro - 🎼 音乐配乐 (环节 14) — L5 重写 (L5 顶级导演级, Phase 13 深度重写)
====================================================
🎼 音乐配乐 (环节 14) — L5 重写
...
class MusicScorePro:
    ...
    def build_music(self, **kwargs):
        ...
        # 节点专属: 领域能力
        domain_name = "音乐配乐"
        domain_focus = "H3 non_diegetic_music 完整 + 11 维导演控制"
        h3_special = "乐器/速度/节奏/动态 (不用情绪词) + 角色能听到 vs 观众能听到"
        director_specifics = "王家卫拉丁探戈 / 奉俊昊古典反差 / 李安东西方对位"
        extra_inject = "H3 配乐监督简报 + 情绪可视化为音乐"
        ...
        main_output += "【" + "MusicScorePro" + "】L5 顶级导演级 - Phase 13 重写\n"
        main_output += "=" * 50 + "\n\n"
