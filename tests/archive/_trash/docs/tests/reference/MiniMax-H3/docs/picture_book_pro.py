# -*- coding: utf-8 -*-
"""
PictureBookPro - 📚 故事绘本 (环节 40) — L5 重写 (L5 顶级导演级, Phase 13 深度重写)
====================================================
📚 故事绘本 (环节 40) — L5 重写
...
class PictureBookPro:
    ...
    def build_book(self, **kwargs):
        ...
        # 节点专属: 领域能力
        domain_name = "故事绘本"
        domain_focus = "H3 I2VA 提示词 + 视觉锚点 + 留白"
        h3_special = "图为主文为辅 + 1-2 句/页 + 字要大留白要够 + 隐喻贯穿"
        director_specifics = "几米城市孤独 / 宫崎骏水彩飞行器 / 塔可夫斯基圣像式静帧"
        extra_inject = "页数节奏 + 适龄分龄 + 隐喻系统 (猫=安全感 树=父亲)"
        ...
        main_output += "【" + "PictureBookPro" + "】L5 顶级导演级 - Phase 13 重写\n"
        main_output += "=" * 50 + "\n\n"
