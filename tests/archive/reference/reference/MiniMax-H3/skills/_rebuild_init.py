...
NODES = [
    ...
    ("Phase14AssetRegistry", "phase14_asset_registry"),
    ("Phase14SpatialLayout", "phase14_spatial_layout"),
    ("Phase14ActingSkill", "phase14_acting_skill"),
    ("Phase14SoundSkill", "phase14_sound_skill"),
    ("IterationPostPro", "phase14_iteration_post"),
    # Phase 14 升级: 30s 6 段 + Cinematic Studio
    ("Phase14_30sSixAct", "phase14_30s_six_act"),
    ("Phase14_CinematicStudio", "phase14_cinematic_studio"),
]
