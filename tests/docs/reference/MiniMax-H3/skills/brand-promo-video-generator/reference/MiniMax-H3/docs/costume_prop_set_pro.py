# -*- coding: utf-8 -*-
"""
CostumePropSetPro - 👘 服化道 (环节 19) — L5 重写 (L5 顶级导演级, Phase 13 深度重写)
====================================================
👘 服化道 (环节 19) — L5 重写
...
class CostumePropSetPro:
    ...
    def build_costume(self, **kwargs):
        ...
        # 节点专属: 领域能力
        domain_name = "服化道"
        domain_focus = "Seedance 2.5 50 参考库 + 9 维光照响应材质 + CIE LAB 颜色"
        h3_special = "50 参考位 = 角色库 (10) + 场景库 (5) + 道具库 (5) — 多集复用"
        director_specifics = "王家卫 26 套旗袍颜色变化 / 奉俊昊发霉 vs 干净 / 侯孝贤闽南衫"
        extra_inject = "asset_id 复用 + 9 维光照材质响应 (棉布/丝绸/皮革/金属/玻璃/木/石/陶)"
        ...
        main_output += "【" + "CostumePropSetPro" + "】L5 顶级导演级 - Phase 13 重写\n"
        main_output += "=" * 50 + "\n\n"
