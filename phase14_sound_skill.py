# -*- coding: utf-8 -*-
"""
Phase14_SoundSkill — 🔊 声音层专家 (Phase 14 集群节点)
====================================================
...
Phase 14 集群角色 (与 phase14_cluster_*.py 互锁):
- 与 phase14_camera_skill 同步: 剪辑点 = 声音尾巴接入点
- 与 phase14_acting_skill 同步: 表演的呼吸/颤抖是声音连续性的物理基础
- 与 phase14_space_skill 同步: GEO SPATIAL LAYOUT 决定 4 层声音的方位
- 与 phase14_assets_skill 同步: 角色资产 = 视觉 + 声音 双契约
- 与 phase14_post_skill 同步: 后期声音清理是"六层生产系统"的第六层
...
def post_process_audio(raw_audio: Dict[str, Any]) -> Dict[str, Any]:
    ...
    plan = {
        ...
        "step_3_spatialization": {
            ...
            "pan_reference": "GEO SPATIAL LAYOUT (from phase14_space_skill)",
...
# =============================================================================
#  ComfyUI 节点封装 (Phase 14 集群标准接口)
# =============================================================================

class Phase14SoundSkill:
    """
    Phase 14 声音层专家节点 - 集群 ComfyUI 入口
    --------------------------------------------------------
    集群内角色: 负责 prompt 的声音层, 与 camera / acting / space / assets / post
               5 个节点互锁, 共同组成 phase14_cluster。
    ...
    RETURN_NAMES = ("phase14_sound_audio_prompt", "sound_experience_matrix", "sound_ai_deep_processing")
    FUNCTION = "build_sound"
    CATEGORY = "PromptLibrary/Phase14 集群"
...
# =============================================================================
#  自测入口 (本文件可直接 python phase14_sound_skill.py 跑, 输出 3 个 demo)
# =============================================================================

if __name__ == "__main__":
    print("\n" + "=" * 60)
    print("Phase 14 声音层专家 - 3 个 Hell Grind 示例")
    print("=" * 60 + "\n")
