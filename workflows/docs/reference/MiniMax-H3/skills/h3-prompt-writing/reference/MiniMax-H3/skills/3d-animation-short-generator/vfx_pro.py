# -*- coding: utf-8 -*-
"""
VfxPro - ✨ VFX (环节 33) — L5 重写 (L5 顶级导演级, Phase 13 深度重写)
====================================================
✨ VFX (环节 33) — L5 重写
...
class VfxPro:
    ...
    def build_vfx(self, **kwargs):
        ...
        # 节点专属: 领域能力
        domain_name = "VFX"
        domain_focus = "3D 白模输入 + 局部编辑 + 空间一致性 + 节制原则"
        h3_special = "3D 白模保留空间结构 + 局部框选修改全局不变 + 真实感 > 炫技"
        director_specifics = "诺兰实拍不靠 CGI / 宫崎骏手绘不用 CGI / 奉俊昊 VFX 减到最低"
        extra_inject = "Seedance 2.5 局部编辑 (框选时间+区域) + 10万面白模输入 + 局部重绘"
        ...
        main_output += "【" + "VfxPro" + "】L5 顶级导演级 - Phase 13 重写\n"
        main_output += "=" * 50 + "\n\n"
