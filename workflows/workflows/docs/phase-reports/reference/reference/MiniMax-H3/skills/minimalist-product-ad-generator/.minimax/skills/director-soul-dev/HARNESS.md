...
**引用**: 通用 HARNESS 在 `../general-dev/HARNESS.md`

---

## 一、本文件用途

通用 HARNESS (`../general-dev/HARNESS.md`) 已覆盖开发前/中/后必做项。
...
- **通用 SKILL**: `../general-dev/SKILL.md`
- **通用 HARNESS**: `../general-dev/HARNESS.md`
- **项目特定 SKILL**: `./SKILL.md` (41 节点 / 14 段 / 5 维具体化 / 6 反 AI 铁律)
