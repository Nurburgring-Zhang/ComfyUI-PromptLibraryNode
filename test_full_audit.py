...
# === 1. 节点注册 ===
check("NODE_CLASS_MAPPINGS 34 节点 (实际 %d)" % len(init.NODE_CLASS_MAPPINGS), len(init.NODE_CLASS_MAPPINGS)==34)
check("NODE_DISPLAY_NAME_MAPPINGS (34 节点)", len(init.NODE_DISPLAY_NAME_MAPPINGS)==34)
